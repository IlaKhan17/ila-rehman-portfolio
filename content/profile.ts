...
export const about = [
  ...
  "Alongside that I have shipped three systems of my own. Davis is an evidence-grounded AI sales agent where every prospect score cites a source URL, a snippet and a timestamp, isolated across organisations by row-level security. Apriciate is a travel agent that lives in WhatsApp, and the interesting part was diagnosing a 56% tool-call failure rate from traces and killing it with date-grounding and a provider fallback. AdaptQuiz is a RAG API that generates questions grounded in your own study material and grades free-text answers against a rubric, tagging the specific gap behind every wrong answer. The grader is the part I care about most. It exists because I spent years marking answers that were right in the wrong words.",
];
